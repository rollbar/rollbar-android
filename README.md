...
Download [rollbar-android.jar](https://github.com/rollbar/rollbar-android/releases/download/v0.0.2/rollbar-android.jar) and place it in your Android project's `libs` directory.
